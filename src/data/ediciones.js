	...
	},
	{
		...
		conferencistas: [
			...
			},
			{
				...
				linkeding:"http://www.linkedin.com/in/samira-carrillo",
				x:"",
			...
			},
			{
				...
				x:"",
				info:"Estefania Lozano Jara es una coach de vida y experta en liderazgo consciente y reinvención emocional. Con experiencia en Banco Pichincha y Banco del Pacífico, se especializa en gestión de datos y analítica. Ha implementado estrategias de migración a la nube y automatización de modelos de machine learning. Además, ha sido reconocida por su excelencia académica y profesional, y ha publicado investigaciones sobre manejo de crisis y análisis de datos en redes sociales."
			}
		],
		talleres: [
		],
