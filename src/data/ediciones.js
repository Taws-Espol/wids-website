export const ediciones = [
	{
		...
		cronograma: [
			...
			},
			{
				...
				imageName: "VanessaEcheverria.png"
			},
			{
	...
	},
	{
		...
		conferencistas: [
			{
				title: "",
				name: "Cindy Cunalata Soledispa",
				place: "BanEcuador",
				work: "Asistente de Riesgo de Crédito y Control Metodológico",
				schedule: "N/A",
				imageName: "CyndyCulanata.jpeg",
				linkeding: "https://www.linkedin.com/in/cindy-cunalata-soledispa-94541a143",
				x: "",
				info: "es una economista con experiencia en investigación económica, desarrollo de metodologías de riesgo de crédito, análisis financiero, estadístico y econométrico. Con conocimientos en lenguajes de programación como Stata, Python y R, así como en la herramienta Power BI. Apasionada por explorar nuevos insights a través de la investigación y el análisis de datos para la toma de decisiones, y bastante comprometida con la excelencia y el desarrollo económico de la sociedad."
			},
				{
				title: "",
