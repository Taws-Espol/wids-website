...
function DrawerOverlay({
  ...
  return (
    <DrawerPrimitive.Overlay
      ...
      className={cn(
        "data-open:fade-in-0 data-closed:fade-out-0 data-closed:animate-out data-open:animate-in fixed inset-0 z-50 supports-backdrop-filter:backdrop-blur-xs",
        className,
      )}
      {...props}
    />
