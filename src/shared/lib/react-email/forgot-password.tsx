...
export const ForgotPassword = ({ url, name }: Props) => {
  return (
    <Html>
      <Head />
      <Preview>Reset your WiDS Guayaquil password</Preview>
      <Tailwind
        config={{
        ...
        <Body className="m-0 bg-transparent px-[16px] py-[32px] font-sans text-[#111827]">
          ...
          >
            ...
            <Section className="mb-[24px]">
              ...
              >
                We received a request to reset the password for your WiDS
                Guayaquil CMS account. Use the button below to choose a new
                password.
              </Text>
            </Section>
