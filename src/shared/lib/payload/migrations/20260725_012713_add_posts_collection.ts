...
export async function down({
  ...
  -- IF EXISTS because "DROP TABLE posts CASCADE" above already removes this
  -- foreign key. Without it the rollback fails with
  -- "constraint ... does not exist" and no migration in this batch can be
  -- rolled back. Generated by migrate:create, which does not account for the
  -- cascade.
