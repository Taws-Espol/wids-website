			...
			<section className='select-none dark:bg-dark  my-2 mx-10 px-20 py-10 max-md:flex max-md:flex-col max-md:place-content-center max-md:place-items-center max-md:p-0 m-0'>
				<div className="flex gap-2 text-center items-center w-full">
					<Link to='/eventos/ediciones'>
						<h1 className="text-primary-dark-green text-4xl font-bold font-acumin max-md:text-2xl max-sm:text-lg my-5">{"Ediciones anteriores  > "}  </h1>
					</Link>
					<h1 className="text-primary-dark-green text-4xl font-bold font-acumin max-md:text-2xl  max-sm:text-lg my-5">Edición {year}</h1>
				</div>
