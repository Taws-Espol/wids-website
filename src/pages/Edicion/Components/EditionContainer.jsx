...
export function EditionContainer({ edicionData }) {
  ...
  return (
    <>
      ...
      <div
        className={`${active === "Cronograma" ? "block" : "hidden"} flex place-content-center place-items-center flex-col my-5 gap-10`}
      >
        {edicionData &&
      ...
      <div
        className={`${active === "Conferencistas" ? "block" : "hidden"} flex place-content-center place-items-center flex-col my-5 gap-10`}
      >
        <ConferenceContainer edicionData={edicionData} />
      </div>
      <div
        className={`${active === "Talleres" ? "block" : "hidden"} flex place-content-center place-items-center flex-col my-5 gap-10`}
      >
        {edicionData &&
