  ...
  return (
    <div className="group relative m-0 h-[1000px] w-full">
      ...
      <div className="absolute left-0 top-0 h-full w-full overflow-hidden group-hover:z-10">
        <div className="text-shadow-black absolute left-[-35%] top-[-72%] h-full w-full select-none overflow-hidden rounded-full bg-primary-yellow font-acumin text-white xsm:left-[-40%] xsm:top-[-67%] sm:left-[-45%] sm:top-[-60%] md:left-[-45%] md:top-[-57%] lg:top-[-50%] xl:left-[-1220px] xl:top-[-50%] xl:h-[1900px] xl:w-[1900px]"></div>
      </div>
      <div className="text-shadow-black max-xl:left-15 absolute left-[5vw] top-[35%] flex select-none flex-col gap-4 font-acumin text-primary-dark-green group-hover:z-20 max-xl:top-10 max-xl:gap-[1.5vw] 5xl:left-[3%]">
        ...
        >
          <button
            className="mt-3 w-52 select-none rounded-3xl bg-primary-dark-green py-3 text-center font-acumin text-4xl font-medium text-white max-sm:w-32 max-sm:text-2xl lg:w-2/3 lg:text-5xl"
            onClick={() =>
