  ...
  return (
    <div className="m-0 h-[1000px] w-full relative group">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden group-hover:z-10">
        <div className="absolute xl:top-[-50%] xl:left-[-1220px] text-white text-shadow-black select-none font-acumin rounded-full xl:h-[1900px] xl:w-[1900px] overflow-hidden bg-primary-yellow h-full w-full top-[-72%] left-[-35%] xsm:left-[-40%] xsm:top-[-67%] sm:top-[-60%] sm:left-[-45%] md:top-[-57%] lg:top-[-50%] md:left-[-45%]"></div>
      </div>
      <div className="absolute top-[35%] left-[5vw] 5xl:left-[3%] text-primary-dark-green text-shadow-black select-none font-acumin group-hover:z-20 flex flex-col max-xl:gap-[1.5vw] gap-4 max-xl:top-10 max-xl:left-15">
        <p className="text-[7vw] xsm:text-[5vw] sm:text-[vw] xl:text-[3.5em] 2xl:text-[4em] 5xl:text-[4em] font-acumin font-bold">
          {infoImages[currentIndex].title}
        </p>
        <p className="text-[4vw] xsm:text-[4vw] sm:text-[3vw] xl:text-[2.5em] 2xl:text-[3em] 5xl:text-[3em] font-acumin font-normal ">
        ...
        >
          <button
            className="text-white mt-3 text-4xl w-52 lg:text-5xl max-sm:text-2xl max-sm:w-32 bg-primary-dark-green select-none rounded-3xl py-3 text-center lg:w-2/3 font-acumin font-medium"
            onClick={() =>
