...
export function Carrusel() {
    ...
    return (
        <div className='m-0 h-[722px] w-full py-2 relative group'>
            ...
            <div className="absolute bottom-[12%] left-1/2 transform -translate-x-1/2 translate-y-1/2 flex justify-around max-xl:bottom-[20%]">
            ...
            <div className="absolute right-[5%] bottom-[5%]  max-sm:left-[52%] max-md:left-[57%]  max-xl:left-[60%]  max-xl:transform max-xl:-translate-x-1/2 max-xl:translate-y-1/2 ">
