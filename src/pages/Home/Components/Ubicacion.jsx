...
const Ubicacion = () => {
    return (
        <div className="md:pb-3 pb-[7vw] pt-[3.5vw] md:pl-3 md:pt-3 bg-neutral-grey bg-opacity-20 text-primary-dark-green flex flex-col md:flex-row items-center select-none !w-full">
