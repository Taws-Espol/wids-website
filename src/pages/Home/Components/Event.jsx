  ...
  return (
    <div className="mb-8 flex items-center justify-center">
      <div className="relative">
        {!isLast && (
          <div className="absolute left-1/2 h-16 w-0.5 -translate-x-1/2 transform bg-gray-300" />
        )}
        <div
          className={`z-10 flex h-12 w-12 items-center justify-center rounded-full ${color} text-white`}
        >
          {Icon}
        </div>
      </div>
