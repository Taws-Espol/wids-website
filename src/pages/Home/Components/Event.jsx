...
import { FaUserAlt, FaMixcloud, FaUtensils, FaMusic, FaFilm } from 'react-icons/fa';
  ...
  return (
    <div className="flex items-center justify-center mb-8">
      <div className="relative">
        ...
        <div className={`z-10 rounded-full h-12 w-12 flex items-center justify-center ${color} text-white`}>
          {Icon}
        </div>
      </div>
