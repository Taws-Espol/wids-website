...
export function InfoSquared({ number, text, color }) {
    ...
    return (
        <div ref={ref} className={`h-[360px] flex flex-col aspect-square ${color} text-5xl text-white font-bold place-content-center place-items-center text-center px-5 gap-5 max-sm:h-[120px] max-sm:w-[120px] max-md:h-[200px] max-md:w-[200px] max-sm:text-sm max-md:text-xl`}>
