...
function Inicio() {
    return (
        <>
            ...
            <AnimatedSection>
                <div className="font-acumin flex flex-col place-content-center place-items-center select-none">
                    <h1 className="font-bold text-5xl">
                        CRONOGRAMA
                    </h1>
                    <h2 className="w-full text-center text-[3.5vw] md:text-[2vw] 2xl:text-[1.5vw] min-[2474]:text-[1vw] font-acumin p-5 font-semibold ">
                        09:00 am - 13:00 pm 
                    </h2>
                    <h2 className="w-full text-center text-[3.5vw] md:text-[2vw] 2xl:text-[1.5vw] min-[2474]:text-[1vw] font-acumin p-5 font-semibold ">
                        {"MUY PRONTO !!"}
