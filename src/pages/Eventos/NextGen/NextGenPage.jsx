...
function NextGen() {
  ...
  return (
    <AnimatedSection>
      <div className="w-full flex flex-col place-content-center place-items-center pb-10 font-acumin select-none">
        ...
        <div className="w-4/5 h-auto rounded-lg pb-0  flex flex-col place-content-center place-items-center">
          <div
            ...
            className="flex max-lg:flex-col max-sm:min-w-[300px] place-content-center place-items-center mb-10 max-sm:gap-10"
          >
        ...
        max-lg:min-w-[600px] max-lg:h-[400px] "
            ...
            <div
              ...
              className="ml-10 text-2xl w-2/5 text-justify px-4 flex flex-col gap-5 max-sm:text-base max-md:text-lg max-lg:text-xl max-lg:w-full max-lg:m-0"
            >
          ...
          <div className="flex flex-col lg:flex-row m-8 w-full bg-custom-white rounded-md  py-10">
            <div className="w-full lg:w-1/2 flex items-center justify-center lg:pl-6 ml-0">
              <h1 className="text-center text-primary-dark-green text-5xl lg:text-6xl font-bold py-5 ">
                {NextGenInfo[1].title}
              </h1>
            </div>
        ...
        <div className="w-4/5 min-h-96 flex-col flex place-content-center place-items-center mt-0 rounded-3xl pb-5">
          <div className="w-3/5 flex justify-center items-center text-center relative mt-10">
            <div
              id="rectangulo"
              className="absolute top-[40px] left-[-375px] w-full h-9 bg-custom-purpl2 z-10 hidden lg:block lg:left-[-375px] lg:top-[40px] lg:h-9 lg:w-full max-lg:w-1/2 max-lg:h-4 max-lg:left-[-50%]"
            ></div>
            <div
              id="rectangulo2"
              className="absolute top-[72px] right-[-370px] w-full h-9 bg-custom-yel z-10 hidden lg:block lg:right-[-370px] lg:top-[72px] lg:h-9 lg:w-full max-lg:w-1/2 max-lg:h-4 max-lg:right-[-50%]"
            ></div>
        ...
        <div className="flex flex-wrap place-content-center place-items-center text-center w-4/5 py-14 relative max-md:pt-10">
          <div
            id="div_nextgen-empoderando"
            className="flex max-lg:flex-col max-sm:min-w-[300px] place-content-center place-items-center"
          >
            <div
              id="nextgen-empoderando"
              className=" ml-10 text-2xl w-2/5 text-justify px-4 flex flex-col gap-5 max-sm:text-base  max-md:text-lg  max-lg:text-xl  max-lg:w-full max-lg:m-0"
      ...
      <div
        className={`flex place-content-center place-items-center flex-col my-5 gap-10`}
      >
        <p className="font-acumin text-primary-dark-green font-bold text-5xl">
          Cronograma
        </p>
