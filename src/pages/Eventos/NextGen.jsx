    ...
    return (
        <div className="w-full flex flex-col place-content-center place-items-center pb-10 font-acumin ">
            ...
            <div className="w-4/5 h-auto rounded-lg pb-0  flex flex-col place-content-center place-items-center">
                <div id='div_nextgen-empoderando' className="flex max-lg:flex-col max-sm:min-w-[300px] place-content-center place-items-center mb-10">
                ...
                <div className="flex flex-col lg:flex-row m-8 w-full bg-custom-white rounded-md  py-10">
                    <div className="w-full lg:w-1/2 ml-0 flex items-center justify-center lg:pl-6 ml-0" >
