export function Label({ type, hiddenDiv, stateHidden }) {
  ...
  return (
    <div class="flex flex-row" onClick={checkSize}>
      <div
        class={`${backgroundColor} w-[450px] ${stateHidden ? 'h-44 place-content-center rounded-md' : 'h-12 rounded-l-full'} mr-0 flex items-center overflow-hidden border-r-0 p-0 font-acumin font-bold max-sm:w-[355px] max-xsm:w-[284px]`}
      >
        <p
