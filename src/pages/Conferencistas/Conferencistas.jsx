...
function Conferencistas() {
    ...
    return (
        <div className="flex flex-col place-content-center place-items-center w-full">
            <div className="w-3/4 flex justify-center items-center text-center relative mt-10 mb-20">
                <div id='rectangulo_corneL' className="absolute bottom-[-30px] left-2 w-96 h-48 bg-custom-peach max-lg:hidden z-[5]"></div>
                <div id='rectangulo_corneR' className="absolute top-[-30px] right-2 w-96 h-48 bg-custom-purple max-lg:hidden z-[5]"></div>
                <div><img src="/assets/Conferences/conference.png" alt="conference" className="w-full h-96 object-cover object-top relative z-[10]" /></div>
