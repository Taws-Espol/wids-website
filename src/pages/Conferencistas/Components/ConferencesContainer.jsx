    ...
    <>
      <div className="font-acumin flex flex-row place-content-center place-items-center gap-10 flex-wrap">
        {conferenceActive && (
          <div
            id={div_principal}
            className="flex flex-row flex-wrap place-content-center place-items-center w-full gap-10 my-20 py-10 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300 hover:shadow-2xl"
          >
            <img
              src={image}
              alt="Conferencista"
              className="h-96 w-96 max-sm:w-80 max-sm:h-80 object-cover rounded-3xl"
            />
            <div className="flex flex-col h-[384px] w-[800px] max-sm:w-[350px] justify-center align-middle rounded-xl p-10 gap-8">
              <div className="flex flex-col max-sm:mt-10">
                <p className="text-primary-dark-green font-bold text-3xl">
              ...
              <div
                className="flex place-content-start w-full min-h-[200px] overflow-y-auto"
                ref={detailsDivRef}
              >
                {" "}
                {}
